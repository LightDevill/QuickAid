    ...
    useEffect(() => {
        const fetchActivity = async () => {
            try {
                ...
                // Assuming useBookingStore or direct API call. Ideally store has fetchMyBookings
                // Let's use direct API call or store action if available
                // Checking store imports: import useBookingStore from '../stores/bookingStore';
                // useBookingStore probably has myBookings or fetchMyBookings

                // Let's assume we can fetch from store or API. 
                // To keep it simple and robust, let's use the store if possible, but I don't see fetch exposed in the restructuring destructure line 12.
                // I'll grab the state update function from store or just use API directly here for quick wiring.

                // Better approach: Use the bookingStore if it handles fetching.
                // But I'll use the API directly for now as I can import it easily.
